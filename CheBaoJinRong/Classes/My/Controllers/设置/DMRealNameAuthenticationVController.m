//
//  DMRealNameAuthenticationVController.m
//  CheBaoJinRong
//
...
#import "DMRealNameModel.h"
#import "DMUserTool.h"

@interface DMRealNameAuthenticationVController ()
...
@implementation DMRealNameAuthenticationVController
    ...
    [YBHttpTool postDataDifference:@"userPerson" params:nil success:^(id  _Nullable obj) {
        ...
        if (obj!= nil) {
            ...
            if (stateModel.status == ResultStatusSuccess) {
                DMRealNameModel *realModel = [DMRealNameModel mj_objectWithKeyValues:obj[@"tPerson"]];
