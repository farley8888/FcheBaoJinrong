...
@interface DMSubstitutePaymentCell ()
...
@implementation DMSubstitutePaymentCell
...
- (void)setCellReturnModel:(DMReturnMoneyModel *)cellReturnModel
{
...
- (void)setCellTransaModel:(DMTransactionRecordModel *)cellTransaModel
{
...
- (void)setCellInvestModel:(DMInvestmentRecordsModel *)cellInvestModel
{
