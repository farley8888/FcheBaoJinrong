...
#import "DMDatePickerTool.h"
#import "DMDefine.h"

@interface DMDatePickerTool ()
...
@implementation DMDatePickerTool
...
{
    DMDatePickerTool *datePicker = [DMDatePickerTool shareTool];
...
+ (DMDatePickerTool *)shareTool
{
    DMDatePickerTool *datePicker = [[DMDatePickerTool alloc] initWithFrame:CGRectMake(0, kScreenH-220, kScreenW, 220)];
    datePicker.backgroundColor = [UIColor whiteColor];
    return datePicker;
}
