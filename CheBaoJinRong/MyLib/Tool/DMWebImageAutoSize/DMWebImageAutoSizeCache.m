//
//  DMWebImageAutoSizeCache.m
//  DMWebImageHeightLayoutExample
//
//  Created by zhuxiaohui on 2016/11/16.
//  Copyright © 2016年 it7090.com. All rights reserved.

#import "DMWebImageAutoSizeCache.h"
#import "NSString+DMWebImageAutoSize.h"
#import "DMWebImageAutoSizeConst.h"

@interface DMWebImageAutoSizeCache()

@property(nonatomic,strong)NSCache * memCache;
@property(nonnull,strong)NSFileManager *fileManager;

@end
@implementation DMWebImageAutoSizeCache

+(DMWebImageAutoSizeCache *)shardCache{
    static DMWebImageAutoSizeCache *instance = nil;
    static dispatch_once_t oneToken;
    dispatch_once(&oneToken,^{
        instance = [[DMWebImageAutoSizeCache alloc] init];
    });
    return instance;
}
...
#pragma mark - DMWebImageAutoSizeCache (private)
...
-(NSString *)baseCacheDirectory{
    ...
    NSString *path = [pathOfLibrary stringByAppendingPathComponent:@"DMWebImageAutoSizeCache"];
    return path;
