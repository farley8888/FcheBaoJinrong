...
#import "DMPickerTool.h"

@interface DMPickerTool ()<UIPickerViewDelegate, UIPickerViewDataSource>
...
{
    DMPickerTool *pickerView = [[DMPickerTool alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height-220, [UIScreen mainScreen].bounds.size.width, 220)];
