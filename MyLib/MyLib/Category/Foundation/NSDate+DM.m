...
{
    return [self dateAddHours:day*24];
}

- (NSDate *)dateAddHours:(NSInteger)hours
{
    return [self dateAddMinute:hours*60];
}

- (NSDate *)dateAddMinute:(NSInteger)minute
{
    NSTimeInterval timeInterval = [self timeIntervalSince1970] + minute*60;
