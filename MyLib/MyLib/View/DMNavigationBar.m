...
//===============================================================================================
@implementation DMNavigationBar (DMDefault)
...
- (void)dm_setBackgroundImage:(UIImage *)image
{
    ...
    if (self.backgroundImageView == nil)
    {
        ...
        {
            self.backgroundImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.bounds), [DMNavigationBar navBarBottom])];
...
- (void)dm_setBackgroundColor:(UIColor *)color
{
    ...
    if (self.backgroundView == nil)
    {
        // add a image(nil color) to _UIBarBackground make it clear
        [self setBackgroundImage:[UIImage new] forBarMetrics:UIBarMetricsDefault];
        self.backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.bounds), [DMNavigationBar navBarBottom])];
...
- (void)updateNavigationBarWithFromVC:(UIViewController *)fromVC toVC:(UIViewController *)toVC progress:(CGFloat)progress
{
    ...
    UIColor *newBarTintColor = [DMNavigationBar middleColor:fromBarTintColor toColor:toBarTintColor percent:progress];
    ...
    UIColor *newTintColor = [DMNavigationBar middleColor:fromTintColor toColor:toTintColor percent:progress];
    ...
    //    UIColor *newTitleColor = [DMNavigationBar middleColor:fromTitleColor toColor:toTitleColor percent:progress];
    ...
    CGFloat newBarBackgroundAlpha = [DMNavigationBar middleAlpha:fromBarBackgroundAlpha toAlpha:toBarBackgroundAlpha percent:progress];
...
- (UIImage *)dm_navBarBackgroundImage
{
    ...
    image = (image == nil) ? [DMNavigationBar defaultNavBarBackgroundImage] : image;
    return image;
}
...
- (UIColor *)dm_navBarBarTintColor
{
    ...
    return (barTintColor != nil) ? barTintColor : [DMNavigationBar defaultNavBarBarTintColor];
}
...
- (CGFloat)dm_navBarBackgroundAlpha
{
    ...
    return (barBackgroundAlpha != nil) ? [barBackgroundAlpha floatValue] : [DMNavigationBar defaultNavBarBackgroundAlpha];
...
- (UIColor *)dm_navBarTintColor
{
    ...
    return (tintColor != nil) ? tintColor : [DMNavigationBar defaultNavBarTintColor];
}
...
- (UIColor *)dm_navBarTitleColor
{
    ...
    return (titleColor != nil) ? titleColor : [DMNavigationBar defaultNavBarTitleColor];
}
...
- (UIStatusBarStyle)dm_statusBarStyle
{
    ...
    return (style != nil) ? [style integerValue] : [DMNavigationBar defaultStatusBarStyle];
}
...
- (BOOL)dm_navBarShadowImageHidden
{
    ...
    return (hidden != nil) ? [hidden boolValue] : [DMNavigationBar defaultNavBarShadowImageHidden];
}
...
- (BOOL)canUpdateNavigationBar
{
    ...
    CGRect middleFrame = CGRectMake(0, DMNavigationBar.navBarBottom, DMNavigationBar.screenWidth, DMNavigationBar.screenHeight-DMNavigationBar.navBarBottom);
    CGRect minFrame = CGRectMake(0, DMNavigationBar.navBarBottom, DMNavigationBar.screenWidth, DMNavigationBar.screenHeight-DMNavigationBar.navBarBottom-DMNavigationBar.tabBarHeight);
    // 蝙蝠🦇 （灵机一动：视频通话问题？）
