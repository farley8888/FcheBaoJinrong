...
@interface XBTLeftView ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)setUI
{
    ...
    UITableView_RegisterFormNib(tableView, @"XBTLeftTabelViewcell");
...
{
    XBTLeftTabelViewcell *cell = [tableView dequeueReusableCellWithIdentifier:@"XBTLeftTabelViewcell" forIndexPath:indexPath];
    cell.type = self.type;
    if(self.type == Finish){
