...
#import "RegularPurchaseController.h"         //立即购买
#import "XBTNavigationController.h"
#import "LonginController.h"

@interface RegularController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) RegularModel *dataModel;
...
- (void)setupUI
{
    ...
    UITableView_RegisterFormNib(tableView, @"XBTRegularCell");
    ...
    [YBHttpTool postDataDifference:@"queryBorrowDetail" params:@{@"id":self.prdID} success:^(id  _Nullable obj) {
        if (obj!=nil) {
            ...
            if (stateModel.status == ResultStatusSuccess) {
                ...
                RegularModel *regMoel = [RegularModel mj_objectWithKeyValues:obj[@"tBorrowModel"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row != 5) {
        ...
        XBTRegularCell *regCell = [tableView dequeueReusableCellWithIdentifier:@"XBTRegularCell" forIndexPath:indexPath];
        cell = regCell;
    }
