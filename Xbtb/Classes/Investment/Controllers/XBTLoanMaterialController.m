...
#import "XBTLoanMaterialController.h"
#import "XBTLoanMaterialCell.h"
#import "XBTLoanMateriaModel.h"

#import "XBTWebImageAutoSize.h"

@interface XBTLoanMaterialController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation XBTLoanMaterialController
...
- (void)setUI
{
    ...
    UITableView_RegisterFormNib(tableView, @"XBTLoanMaterialCell");
...
{
    XBTLoanMaterialCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XBTLoanMaterialCell" forIndexPath:indexPath];
