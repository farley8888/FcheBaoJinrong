...
#import "PurchaseRecordController.h"
#import "XBTPurchaseRecordCell.h"
#import "XBTPurchaseRecordModel.h"



@interface PurchaseRecordController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation PurchaseRecordController
...
- (void)setUI
{
    ...
    UITableView_RegisterFormNib(tableView, @"XBTPurchaseRecordCell");
...
{
    XBTPurchaseRecordCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XBTPurchaseRecordCell" forIndexPath:indexPath];
