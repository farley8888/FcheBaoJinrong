...
@interface DMSellOutController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation DMSellOutController
...
- (void)setUI
{
    ...
    UITableView_RegisterFormNib(tableView, @"DMInvestmentCell");
