//
//  XBTProductInformationController.m
//  CheBaoJinRong
//
...
#import "XBTProductInformationController.h"
#import "XBTProductInformationCell.h"
#import "XBTProductInformationModel.h"

@interface XBTProductInformationController ()
...
@implementation XBTProductInformationController
...
- (void)setUI
{
    UITableView_RegisterFormNib(self.tableView, @"XBTProductInformationCell");
...
{
    XBTProductInformationCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XBTProductInformationCell" forIndexPath:indexPath];
