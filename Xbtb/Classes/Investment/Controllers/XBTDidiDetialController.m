...
@interface XBTDidiDetialController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation XBTDidiDetialController
...
- (void)setupUI
{
    ...
    UITableView_RegisterFormNib(tableView, @"XBTDidiDetialCell");
...
{
    if (indexPath.row == 0) {
        XBTDidiDetialCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XBTDidiDetialCell" forIndexPath:indexPath];
