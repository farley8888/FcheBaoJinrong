...
#import "RegularPurchaseController.h"
...
@interface RegularPurchaseController ()
/**  标题  **/
...
@implementation RegularPurchaseController
...
- (IBAction)sureButtonClick:(id)sender {
    ...
    XBTInputPSWController *inputVC = [[XBTInputPSWController alloc]initWithNibName:@"XBTInputPSWController" bundle:[NSBundle mainBundle]];
