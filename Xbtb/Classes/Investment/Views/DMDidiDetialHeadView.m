...
@interface DMDidiDetialHeadView ()
...
@end
@implementation DMDidiDetialHeadView

+ (DMDidiDetialHeadView *)headView
{
    DMDidiDetialHeadView *headView = [[UINib nibWithNibName:@"DMDidiDetialHeadView" bundle:nil]instantiateWithOwner:self options:nil].lastObject;
    [headView setupUI];
    return headView;
}
