...
@implementation DMMyDidiBadyViewController
...
- (void)setUI
{
    ...
    UITableView_RegisterFormNib(tableView, @"DMMyDidiCell");
...
{
    if (tag == 0) {
        DMWithdrawCashController *wcVC = [DMWithdrawCashController new];
        wcVC.type = Redeem;
