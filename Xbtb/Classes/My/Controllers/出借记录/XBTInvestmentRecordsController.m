//
//  XBTInvestmentRecordsController.m
//  CheBaoJinRong
//
...
@implementation XBTInvestmentRecordsController
...
- (void)setUI
{
    ...
    UITableView_RegisterFormNib(self.tableView, @"XBTSubstitutePaymentCell");
