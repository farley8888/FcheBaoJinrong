...
- (void)setUI
{
    ...
    UITableView_RegisterFormNib(self.tableView, @"XBTSettingCell");
    //    UITableView_AutomaticDimension(self.tableView, 80);
}

- (void)pushGesVC
{
    GestureLockViewController *lockVC = [GestureLockViewController new];
...
{
    XBTSettingCell *setCell = [tableView dequeueReusableCellWithIdentifier:@"XBTSettingCell" forIndexPath:indexPath];
