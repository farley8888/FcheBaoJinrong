...
@interface GestureLockViewController () <DMGestureLockDelegate, UIAlertViewDelegate>
...
//    self.statusLabel = nameLabel;
    ...
    // 九宫格指示器 小图
    GestureLockIndicator *gestureLockIndicator = [[GestureLockIndicator alloc]initWithFrame:CGRectMake((self.view.frame.size.width - 60) * 0.5, 110, 60, 60)];
    ...
    // 九宫格 手势密码页面
    GestureLockView *gestureLockView = [[GestureLockView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height - self.view.frame.size.width - 60 - btnH, self.view.frame.size.width, self.view.frame.size.width)];
...
//            // 保存手势密码
//            [GestureLockViewController addGesturesPassword:gesturesPassword];
//        }];
