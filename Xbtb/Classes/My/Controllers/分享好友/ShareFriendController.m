...
#import "ShareFriendController.h"
...
@interface ShareFriendController ()

@property (nonatomic, strong) NSArray *dataArray;

@end

@implementation ShareFriendController
...
- (void)setupUI
{
    ...
    UITableView_RegisterFormNib(self.tableView, @"XBTShareFriendCell1");
    UITableView_RegisterFormNib(self.tableView, @"XBTShareFriendCell2");
    UITableView_RegisterFormNib(self.tableView, @"XBTShareFriendCell3");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row == 0){
        XBTShareFriendCell1 *cell1 = [tableView dequeueReusableCellWithIdentifier:@"XBTShareFriendCell1" forIndexPath:indexPath];
        cell = cell1;
    }else if (indexPath.row == 1){
        XBTShareFriendCell2 *cell2 = [tableView dequeueReusableCellWithIdentifier:@"XBTShareFriendCell2" forIndexPath:indexPath];
        WeakSelf
        ...
        XBTShareFriendCell3 *cell3 = [tableView dequeueReusableCellWithIdentifier:@"XBTShareFriendCell3" forIndexPath:indexPath];
