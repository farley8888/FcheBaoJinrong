 ...
 *  @param index     图片索引
 */
- (void)cycleView:(XBTCycleView *)cycleView didSelectForIndex:(NSInteger)index;

@end

@interface XBTCycleView : UIView

@property (strong, nonatomic, readonly) XBTCycleScrollView *scrollView;
