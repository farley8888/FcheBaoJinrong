...
- (void)setSelectIndex:(NSInteger)selectIndex
{
     ...
     [self.items enumerateObjectsUsingBlock:^(XBTNavMenuItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
          if (idx>=selectIndex) {
               *stop = YES;
          } else {
               countX += obj.width;
...
- (void)setItems:(NSArray<XBTNavMenuItem *> *)items
{
     _items = items;
     WeakSelf
     [items enumerateObjectsUsingBlock:^(XBTNavMenuItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
