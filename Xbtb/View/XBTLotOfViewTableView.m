...
@interface XBTLotOfViewTableView ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XBTLotOfViewTableView
...
- (void)setTableView
{
    ...
    UITableView_RegisterFormNib(tableView, @"LotOfViewTableViewCell");
