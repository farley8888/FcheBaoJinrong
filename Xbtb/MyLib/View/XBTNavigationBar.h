...
@class XBTCustomNavigationBar;

@interface XBTNavigationBar : UIView
+ (BOOL)isIphoneX;
+ (int)navBarBottom;
+ (int)tabBarHeight;
+ (int)screenWidth;
...
#pragma mark - Default
@interface XBTNavigationBar (DMDefault)
...
/** warning: DM_setDefaultNavBarBackgroundImage is deprecated! place use XBTCustomNavigationBar */
...
/** warning: dm_setDefaultNavBarBackgroundImage is deprecated! place use dmCustomNavigationBar */
//- (void)dm_setCustomNavBar:(XBTCustomNavigationBar *)navBar;
