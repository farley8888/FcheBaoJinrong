...
@interface DMCustomNavigationBar ()
...
@implementation DMCustomNavigationBar

+ (instancetype)CustomNavigationBar {
    DMCustomNavigationBar *navigationBar = [[self alloc] initWithFrame:CGRectMake(0, 0, kDMScreenWidth, [DMCustomNavigationBar navBarBottom])];
...
-(void)updateFrame
{
    NSInteger top = ([DMCustomNavigationBar isIphoneX]) ? 44 : 20;
    NSInteger margin = 5;
...
+ (int)navBarBottom
{
    if ([DMCustomNavigationBar isIphoneX]) {
        return 88;
    } else {
        return 64;
    }
