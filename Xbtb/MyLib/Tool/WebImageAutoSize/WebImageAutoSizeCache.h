...
typedef void(^WebImageAutoSizeCacheCompletionBlock)(BOOL result);

@interface WebImageAutoSizeCache : NSObject

/**
 * Return global shared cache instance
 *
 * @return WebImageAutoSizeCache global instance
 */
