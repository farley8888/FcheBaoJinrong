...
@implementation XBTWebImageAutoSize
...
+(void)storeImageSize:(UIImage *)image forURL:(NSURL *)url completed:(nullable WebImageAutoSizeCacheCompletionBlock)completedBlock{
    [[WebImageAutoSizeCache shardCache] storeImageSize:image forKey:[self cacheKeyForURL:url] completed:completedBlock];
}

+(void)storeReloadState:(BOOL)state forURL:(NSURL *)url completed:(nullable WebImageAutoSizeCacheCompletionBlock)completedBlock{
    [[WebImageAutoSizeCache shardCache] storeReloadState:state forKey:[self cacheKeyForURL:url] completed:completedBlock];
}

+(CGSize )imageSizeFromCacheForURL:(NSURL *)url{
    return [[WebImageAutoSizeCache shardCache] imageSizeFromCacheForKey:[self cacheKeyForURL:url]];
}

+(BOOL)reloadStateFromCacheForURL:(NSURL *)url{
  return [[WebImageAutoSizeCache shardCache] reloadStateFromCacheForKey:[self cacheKeyForURL:url]];
}
